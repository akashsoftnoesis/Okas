...
export default function EmailIcon(props) {
    const body = `Look, I found this awesome property from Okas Property Group.\nTake a look - ${props.url}`
    return (
        <a
            href={`mailto:?body=${encodeURIComponent(body)}&subject=${props.subject}`}
            target="_blank"
            rel="noopener noreferrer"
            className={props.className}
        >
            <Image loading="eager" src={mail} alt="" height="35" width="35" />
