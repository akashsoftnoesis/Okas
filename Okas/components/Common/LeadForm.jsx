    ...
    if (agentEmail) {
      ...
      mailRecipientJson["send_cc"] =
        data.type === "Sales Appraisal"
          ...
          : "nirali@okaspropertygroup.com.au,hardik@okaspropertygroup.com.au,info@okasre.com.au";
    } else {
  ...
  return (
    <>
      {success && <Alert color={success === 'success' ? 'success' : 'danger'}>
        {success === 'success' ? <><strong>Success! </strong> Request an lead mail has been sent.</> :
        <><strong>Sorry!</strong> Your request an lead mail has not been sent. </>}
      </Alert>
      }
